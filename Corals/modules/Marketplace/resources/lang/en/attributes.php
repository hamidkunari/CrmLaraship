...
return [
    ...
    'product' => [
        ...
        'offers' => [
            ...
            'add_offer' => "<i class='fa fa-plus'></i> Add Offer",
            'value' => 'Value',
            'bundle_price_description' => "Buy :quantity for :value",
            'get_free_description' => "Buy :quantity get :value FREE",
        ],
        'price_per_quantity' => [
            'title' => 'Product Price Per Quantity',
            'quantity' => 'Quantity',
            'max_qty' => 'Max Qty.',
            'min_qty' => 'Min Qty.',
            'price' => 'Price',
            'description' => 'Description',
            'type' => 'Type',
            'add_price_per_quantity' => "<i class='fa fa-plus'></i> Add Price Per Quantity",
        ...
        'without_taxes' => 'No Taxes',
        'shippable' => 'Shippable',
        'product_shipping_enabled' => [
            '1' => 'Shippable',
            '0' => 'Virtual',
        ],
        ...
        'package' => 'Package',
        'show_skus_as' => 'Show Variations As',
        'show_skus_as_options' => [
            'radio_skus' => 'Grid of Buttons',
            'select_skus' => 'Dropdown Select',
            'options_skus' => 'Select By Options',
        ]
    ],
    'package' => [
        'name' => 'Name',
    ...
    'shipping' => [
        ...
        'other_shipping' => 'Other Shipping Provider Name',
        'other_option' => [
            'other' => 'Other',
        ]
    ],
