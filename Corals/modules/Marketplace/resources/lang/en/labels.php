...
return [
    ...
    'settings' => [
        ...
        'shipping' => [
            ...
            'shippable_countries' => 'Shippable Countries',
            'enable_shipping_per_product' => 'Enable Vendor Shipping Per Product Settings Options',
            'show_shipping_details' => 'Show shipping details in checkout',
        ],
        'bank_information' => 'Bank Information',
        'tax' => [
            'calculate_tax' => 'Enable Tax Calculation',
            'tax_included_in_price' => 'Taxes included in price'
        ],
        'rating' => [
        ...
        'payout' => [
            ...
            'min_transaction_age' => 'Minimum transaction age for auto transfer (Days) ',
    ...
    'connect_accounts' => [
        ...
        'not_connected' => 'Your account not connected yet.',
        'connect_url' => 'Connect With :gateway',
        'recheck_status' => 'Recheck Status',
        'account_fetch_submitted' => 'Request has been submitted successfully',
    ],
    'product' => [
        ...
        'clone_product' => "<i class='fa fa-copy'></i> Duplicate Product",
        'clone_product_with_media' => 'Duplicate with images'
    ],
    'bulkGenerate' => [
    ...
    'checkout' => [
        ...
        'shipping_options' => 'Product: :products ',
        'cart_shipping_options' => 'Cart: :products',
        'sub_total' => 'Subtotal',
        'tax' => 'Tax',
        'discount' => 'Discount',
        'total' => 'Your Total',
    ...
    'shipping' => [
        ...
        'dimensions_needed' => 'Dimensions are needed for shipping providers like Shippo.',
    ],
    'shop' => [
        'title' => 'Orders',
        'my_orders' => 'My Orders',
    ...
    'package' => [
        ...
        'product_shipping_options' => [
            'calculate_rates' => 'Shipping rules',
            'flat_rate_prices' => "Special rates",
        ],
    ],
];
