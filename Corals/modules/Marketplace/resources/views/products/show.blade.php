            ...
            @component('components.box',['box_class'=>'box-success'])
                ...
                <div class="table-responsive">
                    <table class="table color-table info-table table table-hover table-striped table-condensed">
                        ...
                        <tr>
                            <td>@lang('Marketplace::attributes.product.offers.title')</td>
                            <td>{!! $product->present('offers') !!}</td>
                        </tr>

                        @if($product->price_per_quantity)
                            <tr>
                                <td>@lang('Marketplace::attributes.product.price_per_quantity.title')</td>
                                <td>{!! $product->present('price_per_quantity') !!}</td>
                            </tr>
                        @endif
