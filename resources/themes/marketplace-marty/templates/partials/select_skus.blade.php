        ...
        <div class="form-group">
            <select class="select-product-skus" style="width: 100%" name="sku_hash">
                ...
                <option selected disabled data-default-option="1">
                    @lang('corals-marketplace-marty::labels.template.product_single.select_sku')
                </option>
...
@push('partial_js')
    <script>
        function formatSKUs(state) {
            ...
            return $(`<span  ><img src="${img}" class="img-fluid" style="width: 20%" />  ${state.text}  ${htmlPrice} </span>`);
        }
